...
The work described in this thesis is part of a program that is pioneering the use of shotgun metagenomics and metaproteomics in Antarctic lake and represent the largest datasets of their kind obtained for these environments.
...
Further studies taking a similar approach are necessary to establish the community composition and function throughout the year, particularly in the winter when there is no light to sustain primary production.
Bioinformatic pipelines and theoretical models, such as the metaproteomics workflow described in chapter \ref{ch:ace} and modified Lotka-Volterra predator of a predator model in chapter \ref{ch:olv}, can be applied to these subsequent studies.
A sufficient understanding of the lake community has been established that the questions concerning specific populations and functions of the community can now be targeted.
Testing some of the questions concerning specific populations and functions of the community can be addressed to some extent by `-omics' approaches, especially targeted metagenomic analyses.
But for other specific aims, emerging technologies look to be promising (such as viral tagging, single cell genomics, single virus genomes) complementary techniques
...
To truly establish a baseline for the community, an examination of an annual cycle needs to be performed.
This can address specific questions such as
