...
\ac{OLV} proteins include OLV9, the homologue of Sputnik V20 \ac{MCP}, and OLV8, a fusion of the uncharacterised V18 and minor virion protein V19 from Sputnik (\figreft{fig:OLV_genome} and \tabref{tab:olv_annotation}). 
...
From surface water samples of nearby Ace Lake (meromictic, surface 2\% salinity), a large number of sequences were obtained that matched both the \ac{OLV} \ac{MCP} (\figreft{fig:OLV_time}, \figreft{fig:OLV_phylogeny} and \tabreft{tab:olv_mcp_blastp}) and \acp{PV} (14). 
