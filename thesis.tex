...
\usepackage{pdflscape} %This package is meant to let you turn a single page into a landscape view by writing the section in the landscape environment. Could conflict with sidewaystable?
