...
The majority of lakes are found in the coastal oases. %How many?
...
A comprehensive list of PCR-based molecular surveys of Antarctic lakes are provided in the Appendix \tabreft{tab:pcr_lakes}.
...
These \ac{PCR} based analyses of Antarctic lake communities have shed light on their diversity, temporal and spatial distributions and started to delve into the key drivers in whole ecosystem function.

Relatively few metagenomic studies, which entail random sequencing of environmental \textsc{DNA}, have been conducted on Antarctic lakes (described in \citet{Lopez-Bueno2009, Ng2010a, Lauro2011, Yau2011} and Chapters \ref{ch:ace}, \ref{ch:olv} and \ref{ch:org} of this thesis).
However, these few studies have been able to assess both the taxonomic composition and genetic potential of lake communities, and in some cases have linked function to specific members of the community.
When coupled with functional ``-omic'' techniques (to date metaproteomics has been applied, but not metatranscriptomics or stable isotope probing), information has also been gained about the genetic complement that has been expressed by the resident populations (described in \citet{Ng2010a,Lauro2011,Yau2011} and Chapters \ref{ch:ace} and \ref{ch:olv} of this thesis.) 

%------------------------------------------------------------------------------------------
\subsection{Bacterial diversity: adaptation to unique physical and chemical conditions}

The vast majority of molecular studies of Antarctic lakes have focused on \emph{Bacteria}.
...
For instance, in Ace Lake the mixotrophic phytoflagellate Pyramimonas gelidocola derives a proportion of its carbon intake through bacterivory \cite{Bell2003} but in the nearby Highway Lake, it uptakes dissolved organic carbon \cite{Laybourn-Parry2005}. 
...
One such study is Blood Falls, an outflow of anoxic ferrous brine from the Taylor Glacier in the McMurdo Dry Valleys, where an unusual iron–sulphur cycle was inferred to exist. 
...
The motivation for adopting metagenomic and other `-omics' approaches has stemmed from the inability to obtain physiological data from \ac{PCR}-based taxonomic surveys of environments.
Although metabolic capacity can often be inferred if there are cultured representatives, close relatives with defined physiologies are often not available.
...
Analysis of the viriome of the freshwater Lake Limnopolar, Livingston Island uncovered the greatest depth of viral diversity of any aquatic system to date \cite{Lopez-Bueno2009}.
...
However, subsequent analysis indicates multiple displacement amplification of low quantities of starting \textsc{DNA} used in virome study leads to a stochastic amplification bias rendering the metagenomes non-quantitative \cite{Yilmaz2010}.
...
Metagenomic sequencing is a powerful tool in understanding members of the community, such as viruses, that have largely eluded \ac{PCR}-based techniques.
%-----------------------------------------------------------------------------------------------------------------

\section{Objectives}
This study aimed to use a metagenomic approach combined with microscopy, metaproteomics and abiotic data to gain an integrative understanding of Antarctic lake ecosystems.
Ace Lake and Organic Lake were chosen as the study sites as there are extensive historic environmental data available for them and as they are meromictic lakes, differences in the microbial population can be examined across vertical gradients.
