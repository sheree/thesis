...
\section{Overview of research on Ace and Organic Lakes}
...
The most extensive records exist for physical and chemical properties of the lakes, of which the most consistently recorded variables that have been measured are temperature and conductivity.
These parameters have given an understanding of the water column structure and the factors driving its changes over time.
For example, regular temperature and conductivity measurements from Organic Lake between 1978--1994 showed decreasing water level correlated with increased salinity and deeper mixing of the upper layers of the water column \cite{Gibson1995, Gibson1996}.
Ace Lake similarly showed a shift downward of the halocline from 5 m \cite{Rankin1999} to 12 m \cite{Lauro2011} due to negative water balance.
As lake stratification is sensitive to water balance, which is determined by precipitation and ablation, records of water column structure from Ace Lake and Organic Lake serve as indicators of local climatic change in the past few decades \cite{Gibson1995}.
...
\citet{Rankin1999} describes Ace Lake's history from a freshwater lake ($\sim$10,000 BP), that experienced a subsequent marine incursion ($\sim$8,000 BP), developed anoxia in the bottom waters ($\sim$5,000 BP) and finally completely separated from the sea ($\sim$2,000 BP).
Organic Lake is relatively younger and formed as a marine basin ($\sim$6,000 BP), that later separated from the sea (2,700 BP), although there is evidence of eposodic marine inputs in that time \cite{Bird1991}.
...
The anoxic conditions in the monimolimnion of meromictic lakes preserve a record of the lake biota.
Several studies have specifically examined the palaeobiology of Ace and Organic Lakes.
The first of these studies examined a sediment core from Ace Lake using hydrocarbons as markers of the bacteria and algae, which indicated large changes had occured in biotic composition over the lake's history \cite{Volkman1986}.
...
Studies of Organic Lake's palaeolimnology include \cite{Bird1991}.
