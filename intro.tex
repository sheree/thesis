...
Most of the data that have been recorded are of the physical and chemical properties of the lakes with the most consistently measured variables being temperature and conductivity.
These parameters have given an understanding of the water column structure and recorded its changes since the lakes were first visited.
...
Ace Lake's halocline has similarly shifted downward from 7 m \cite{Rankin1999} to 12 m in 2008 \cite{Lauro2011}, also likely due to negative water balance.
...
%The first of these studies examined a sediment core from Ace Lake using hydrocarbons as markers of the bacteria and algae, which indicated large changes had occured in biotic composition over the lake's history \cite{Volkman1986}.
%A subsequent study examined sediment cores from both Ace Lake and Organic Lake using $^{14}$C dating to constrain the occurrence of microbial populations in time \cite{Bird1991}.
\citet{Rankin1999} describes Ace Lake's history from a freshwater lake $\sim$10,000 BP that became saline after a marine incursion $\sim$8,000 BP and developed anoxia in the bottom waters $\sim$5,000 BP.
Organic Lake formed as a marine basin $\sim$6,000 BP and later separated from the sea 2,700 BP \cite{Bird1991}.

The anoxic conditions in the monimolimnion of meromictic lakes preserve a record of the lake biota in the sediments and have allowed the paleobiology of the lakes to be studied.
The first study Ace Lake's palaeobiology examined a sediment core using hydrocarbons as markers of the bacteria and algae identifying large changes had occured in biotic composition over the lake's history \cite{Volkman1986}.
A subsequent study examined sediment cores from both Ace Lake and Organic Lake using $^{14}$C dating was able to constrain dates of the transitions between marine and lake communities \cite{Bird1991}.



In terms of lake biology, studies that have taken place in the last decades have utilised distinct approaches and have generally focused on particular populations within the lake.
...
For Ace Lake, an extensive review was published on Ace Lake's limnology by \citet{Rankin1999} covering its chemistry, history, paleobiology and microbiology.
...
Flow cytometry used on cyanobacteria: Rankin1997
...
No molecular studies had been undertaken of the water column.
