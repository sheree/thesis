...
The majority of these recorded data are of the lakes' physical and chemical properties such as temperature, conductivity and pH.
These parameters have given an understanding of the water column structure and recorded how it has changed since the lakes were first visited.
Both lakes appear to be continuously stratified, however the water column structure varies according to inter-related seasonal factors such as ice-formation and wind mixing.
For example, regular temperature and conductivity measurements from Organic Lake between 1978--1994 showed decreasing water level correlated with deeper mixing of the water column \cite{Gibson1995, Gibson1996}.
...
Other chemical analyses have been performed designed to infer biogeochemical processes.
For Organic Lake, dissolved organic acids \cite{Gibson1994} and volatile sulphur compounds have been examined \cite{Franzmann1987b, Gibson1991, Roberts1993a, Roberts1993b}.
...
DOC and POC etc?
Ace Lake is the only meromictic lake for which methanogenesis has been reported \cite{Rankin1999} but was from Franzmann1991b.

Several studies have specifically examined the physical evolution of Ace and Organic Lakes.
\citet{Rankin1999} describes Ace Lake's history from its origin as a freshwater lake $\sim$10,000 BP, its later transition to saline after a marine incursion $\sim$8,000 BP, to its final development of meromixis and isolation $\sim$5,000 BP.
In contrast, Organic Lake did not begin as freshwater but formed as a marine basin $\sim$6,000 BP and later separated from the sea 2,700 BP \cite{Bird1991}.
...
The first study Ace Lake's palaeobiology examined a sediment core using hydrocarbons as markers of the bacteria and algae identifying large changes had occured in biotic composition over the lake's history \cite{Volkman1986, Volkman1988}.
A subsequent study that examined sediment cores from both Ace Lake and Organic Lake using $^{14}$C dating was able to constrain dates of the transitions between marine and lake communities \cite{Bird1991}.

Ace Lake's sediments have been the subject of further palaeobiological studies that have utilised microscopy of microfossils and stratiographic analysis of biomarkers complemented with molecular analysis of preserved \textsc{DNA}.
...
Microfossils of freshwater rotifier \emph{Notholca} and dinoflagellate and chrysophyte cysts further showed the early freshwater lake community was diverse consisting of several established trophic levels \cite{Swadling2001}.
Group the microscopy ones together.

Group the biomarkers together
Methods for carotenoid analysis in sediments developed by \citet{Hopman2005}.
...
Note this was a 25 cm core, not 150--175cm cores that Coolen have used.
They found biomarkers for haptophyte algae, markers for methanogenic Archaea, methanotrophic bacterial markers, \ac{GSB} biomarkers and NO markers for ANME. 
Note there was a reference for another Sniggy Damste paper in this one for novel biomarker 2001.

Subsequent biomarker analyses were paired with focussed molecular analyses.
...
Later depletion of sulphate probably occurred 3,000 BP that allowed for methanogenesis to establish \cite{Coolen2006}.

In terms of lake extant lake biology, studies that have taken place in the last decades have utilised distinct approaches and have generally focused on particular populations within the lake.
Methods for examining the lake's biological consortia includes lipid and pigment composition, microscopic examination, biochemical rate measurements, isolation and molecular analysis.
For Ace Lake, an extensive review was published on Ace Lake's limnology by \citet{Rankin1999} covering its chemistry, history and biology.
...
Benthic communities consist of microbial mats \cite{Hand1981, Wright1981, Dartnall1997} including algae (Dartnall1997) and diatoms \cite{Roberts1996} with associated ciliates, copepods and rotifers (Dartnall1997).
...
This illustrates how knowledge of the whole microbial community is lacking as previous research has generally focussed on isolates or specific populations.
