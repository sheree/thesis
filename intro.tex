...
Physical parameters for Ace Lake have been collected since 1974 and for Organic Lake since 1978
(\url{https://data.aad.gov.au/aadc/lakes/}.
In terms of biological studies, for Ace Lake, an extensive review has been published describing its limnology from 1974-1999 \cite{Rankin1999}.
Within this review, fourteen publications were described that examined eucaryotic and photosynthetic bacterial species diversity by microscopic analysis or pigment chemistry and by isolation of \emph{Bacteria} and \emph{Archaea} \cite{Rankin1999}.
...
Futhermore, several years have elapsed since the last microbial surveys of the lakes and the sampling for these studies, over which time ecological changes may have occurred.
Using high-thoughput molecular-based analyses enabled an unprecedented level of detail in the description of the microbial community composition and function.
