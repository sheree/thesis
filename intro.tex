...
These lakes are found dotted around the continent generally under the continental ice shelf\cite{Siegert}.%ref Pearce 2009.
...
They are potentially the most common lake type as they can occur where ever there is rock and thus are both inland and coastal\cite{Hodgeson2012}. % gibson2006?
...
Most studies of Antarctic viruses have been confined to diversity analyses based on the electron micrographs of virus-like particle (VLP) morphotypes or visibly infected cells. 
...
\label{in:mol}
The majority of molecular-based studies of Antarctic aquatic microbial communities have made use of PCR amplification of small subunit ribosomal RNA sequences to survey the diversity of \textit{Bacteria}
 and in some cases \textit{Archaea} and \textit{Eucarya}. %table
...
Hypersaline lakes from the Vestfold Hills \cite{Bowman2000b} and McMurdo Dry Valleys \cite{Glatz2006, Mosier2007} were all dominated by \textit{Gammaproteobacteria} and members of the Bacteroidetes
...
The bacterial population of Heywood Lake had shifted from a dominance of \textit{Cyanobacteria} towards a greater abundance of \textit{Actinobacteria} and marine \textit{Alphaproteobacteria} \cite{Pearce2005}.
This hints at a link between a copiotrophic lifestyle in the Heywood Lake \textit{Actinobacteria} and inhibition of Antarctic freshwater \textit{Cyanobacteria} by eutrophication. 
...
A good example of this is the presence of common types of purple sulfur bacteria (\textit{Chromatiales})and green sulfur bacteria (\textit{Chlorobi}) 
...
The east lobe was dominated by \textit{Gammaproteobacteria} and the west lobe by \textit{Bacteroidetes}, illustrating how divergent communities can form from the same seed population. 
...
Accretion ice has been found to contain a low density of bacterial cells from \textit{Alphaproteobacteria}, \textit{Betaproteobacteria}, \textit{Actinobacteria} and \textit{Bacteroidetes} divisions closely allied to other cold environments.
Molecular signatures of a thermophilic \textit{Hydrogenophilus} species were also identified in accretion ice 
...
Two of these were \textit{Sphingomonas} phylotypes essentially identical to those found in the accretion ice-core \cite{Christner2000},
...
\subsection{\textit{Archaea}: Methanogens and Haloarchaea}
\textit{Archaea} have been detected mainly in anoxic sediments and bottom waters from lakes that range in salinity from fresh to hypersaline, 
...
Anoxia allows for the growth of methanogenic \textit{Archaea} that mineralize fermentation products such as acetate, H$_2$ and CO$_2$ into methane, thereby performing an important step in carbon cycling.
...
One example of this is Lake Heywood where methanogenic \textit{Archaea} were found to comprise 34\% of the total microbial population in the freshwater sediment, 
the majority of which were \textit{Methanosarcinales} which include acetate and C1-compound utilizing methanogens \cite{Purdy2003}. 
Both H$_2$:CO$_2$ (\textit{Methanogenium frigidum}) and methylamine/methanol (\textit{Methanococcoides burtonii}) utilizing methanogens were isolated from Ace Lake 
...
Sediments from saline lakes of the Vestfold Hills were inhabited by members of the \textit{Euryarchaeota} typically found in sediment and marine environments 
with the phylotypes differing between the lakes examined \cite{Bowman2000a}. 
While a phylotype similar to \textit{Methanosarcina} was identified, the majority were highly divergent. 
Similarly, \textit{Methanosarcina} and \textit{Methanoculleus} were detected in Lake Fryxell but other members of the \textit{Euryarchaeota} and \textit{Crenarchaeota} (a single sequence) were divergent, 
...
In hypersaline lakes where bottom waters do not become completely anoxic, methanogens are not present and \textit{Archaea} have extremely low abundance. 
...
and Organic Lake in the Vestfold Hills had an extremely low abundance of archaeal clones related to \textit{Halobacteriales} \cite{Bowman2000b}. 
...
\subsection{\textit{Eucarya} Perform Multiple Ecosystem Roles}

Single-celled \textit{Eucarya} are important members of Antarctic aquatic microbial communities.
...
For example, five morphotypes of \textit{Chrysophyceae}, evident in Antarctic lakes were unidentifiable by light microscopy but were able to be classified using DGGE and DNA sequencing \cite{Unrein2005}.
...
For example, the majority of the \textit{Gammaproteobacteria} in hypersaline lakes were relatives of \textit{Marinobacter} suggesting that this genus is particularly adapted to hypersaline systems
...
This also applies to \textit{Eucarya}, as the influence of flagellates on ecosystem function is not necessarily clear-cut as they can simultaneously inhabit several trophic levels. 
