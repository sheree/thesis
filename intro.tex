...
Data have been collected about Ace Lake and Organic Lake since 1974 and 1978 respectively 
(\url{https://data.aad.gov.au/aadc/lakes/}).
Primarily, these data are of physical and chemical properties of the lakes, the most consistently measured variables being temperature, conductivity and pH.
Water balance is a determiner of the water column structure \cite{Gibson1995}, thus monitoring water column structure is an indicator of the local climatic changes (\emph{e.g.} precipitation and ablation).
Regular measurements of temperature and conductivity/density of Organic Lake from 1978--1994 has correlated decreasing water level with increased salinity, increased depth of the pycnocline and lower temperature \cite{Gibson1995, Gibson1996}, which is proposed to be a general trend in from all meromictic lakes in the area.
For example, Ace Lake was known from an early stage to be fairly stably stratified.
Since the last measurements in X, the chemocline moved down several meters.

In terms of biology, more intermitten studies have taken place in the last decades.
An extensive review was published on Ace Lake's limnology by \citet{Rankin1999} covering its chemistry, history, paleobiology and microbiology.
...
Since then, studies examining the microbial community include microscopy-based surveys phytoplankton \cite{Bell2003, Powell2005}, a \ac{SSU} gene survey of the sediments \cite{Bowman2000a} and molecular analysis of heterotrophic bacterial isolates \cite{VanTrappen2002}.

From Organic Lake, the earliest publication reported the first choanoflagellate to be found in a hypersaline environment \cite{vandenHoff1986}. 
...
Subsequent work on Organic Lake's microbial community similarly included microscopy-based surveys of the phyto- and bacterioplankton \cite{Roberts1996, Perriss1997}, a geolipid survey of the sediments \cite{Rogerson1996} and a molecular survey of the sediments \cite{Bowman2000b} and of isolates \cite{VanTrappen2002}.
