...
As meromictic lakes, differences in the microbial population could be examined along the vertical gradients within the lakes.
Finally, as they are marine-derived systems, comparison between the lake system and the marine environment could be used to identify specific lake adaptations.
...
\item
  To integrate environmental and biological data to model the lake microbial interactions and biogeochemical processes.
