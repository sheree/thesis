...
Marker genes not represented by a \ac{KO} group were assessed by \textsc{BLASTp} queries of marker gene sequences with experimentally confirmed function (Supplementary Table S3) against a database of translated \acp{ORF} predicted from metagenomic reads. 
...
\input{orglake_figures/physico_chem_profiles.tex} 
