...
This study aimed to develop and apply methodologies which provide independant data to complement metagenomic analysis of the Ace Lake ecosystem.
Although metagenomics is an extremely powerful tool for interrogating microbial communities, a systems level understanding ultimately requires the integration of data which metagenomic sequencing alone does not provide such as abiotic parameters and gene expression levels \cite{Handelsman2008}.
...
Both these approaches have added crucial information to the extensive metagenomic datasets allowing for an integrative understanding of the whole lake ecosystem.
