...
Preliminary work on the metaproteome down the vertical profile of Ace Lake has been performed using the \ac{NCBI} \ac{NR} database (cite Ng PhD thesis). %cite Charmaine PhD Thesis.
...
Average counts from the open ocean are X.
Viral counts from various aquatic environments have differed from site to site indicating a variable role of virally mediated mortality. %ref microbial ecology of the oceans.
...
\begin{enumerate}
\item They have defined pore-sizes. %Look up track etch technology
\item They are available in 0.015 $\mu$m pore-sizes allowing capture of \acp{VLP}.
...
As the filtration and visualization was performed on fixed samples in the laboratory the time taken for filtration of 2--3 hours for each sample, this was not deemed problematic for this study.
