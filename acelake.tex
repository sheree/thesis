\chapter[Development and application of complementary methodologies to Ace Lake metagenomic analysis]{Development and application of complementary methodologies to Ace Lake metagenomic analysis}
\label{ch:ace}
\acresetall
...
Ace Lake is a meromictic saline lake in the Vestfold Hills that separated from the sea $\sim$5,000 BP. %ref.
...
The only metazoan life present are callanoid copepods. %Look up
...
a \ac{BLAST} nucleotide database was created from the Sanger reads of the 0.1 \textmu{}m fraction of samples GS230, GS231 and GS232 (see \tabreft{tab:ace_metag} for summary of the metagenomic data).
...
The 0.01 \textmu{}m 25 mm \a{PCTE} filters are difficult to handle compared to 25 mm Anodisc filters that have a plastic support ring around the edge.
